...
# Group by emotion and calculate the average of other metrics
...
# Plot emotion against typing speed
...
# Plot emotion against syntax errors
plt.figure(figsize=(10, 6))
...
# Plot emotion against window switches
plt.figure(figsize=(10, 6))
